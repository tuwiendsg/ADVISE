package at.ac.tuwien.dsg.rsybl.enforcementPlugins.salsa.common;

import at.ac.tuwien.dsg.csdg.Node;
import at.ac.tuwien.dsg.rsybl.utils.Configuration;
            ...
            try {
                ...
                if (errorStream != null) {
                    ...
                    while ((line = reader.readLine()) != null) {
                        java.util.logging.Logger.getLogger(DefaultSalsaClient.class.getName()).log(java.util.logging.Level.SEVERE, line);
                    }
                }
